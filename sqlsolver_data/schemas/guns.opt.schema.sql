...
--
-- Host: 10.0.0.102    Database: guns_opt
-- ------------------------------------------------------
...
CREATE TABLE `sys_dict` (
  ...
  KEY `sys_dict_dict_type_id` (`dict_type_id`)
...
CREATE TABLE `sys_dict_type` (
  ...
  KEY `sys_dict_type_sort` (`sort`),
  KEY `sys_dict_type_sort_system_flag` (`system_flag`,`sort`)
...
CREATE TABLE `sys_menu` (
  ...
  KEY `sys_menu_levels_status` (`levels`,`status`)
